              ...
              {{ csrf_field() }}
                ...
                <div class="form-group">
                  ...
                  <div class="form-group{{ $errors->has('sequence') ? ' has-error' : '' }}">
                      ...
                      <div class="col-sm-10">
                          <input type="number" class="form-control" id="sequence" name="sequence" value="{{ $editPage->sequence!='' ? $editPage->sequence : old('sequence') }}" >
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-10">
                          <input type="checkbox" id="show_in_menu" name="show_in_menu" class="flat-red" value="1" {{ ( (old('show_in_menu') == 1) || ($editPage->show_in_menu == 1) )? 'checked="checked"' : '' }}>{{ "&nbsp; Enable to show in menu " }}
                      </div>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                  	<textarea class="form-control" rows="3" id="page_title" name="page_title" placeholder="Meta Title.">{{ $editPage->page_title != '' ? $editPage->page_title :  old('page_title') }}</textarea>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                  	<textarea class="form-control" rows="3" id="page_keyword" name="page_keyword" placeholder="Meta Keyword.">{{ $editPage->page_keyword != '' ? $editPage->page_keyword : old('page_keyword') }}</textarea>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                  	<textarea class="form-control" rows="3" id="page_description" name="page_description" placeholder="Meta Description.">{{ $editPage->page_description != '' ? $editPage->page_description : old('page_description') }}</textarea>
                  </div>
                </div>
